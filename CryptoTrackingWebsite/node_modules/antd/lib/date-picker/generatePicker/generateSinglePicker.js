    ...
    var Picker = /*#__PURE__*/function (_React$Component) {
      ...
      function Picker(props) {
        ...
        _this.renderFeedback = function (prefixCls) {
          return /*#__PURE__*/React.createElement(_context.FormItemStatusContext.Consumer, null, function (_ref) {
            var hasFeedback = _ref.hasFeedback,
                contextStatus = _ref.status;
            var customStatus = _this.props.status;
            var status = (0, _statusUtils.getMergedStatus)(contextStatus, customStatus);
            return hasFeedback && (0, _statusUtils.getFeedbackIcon)(prefixCls, status);
          });
        };

        _this.renderSuffix = function (prefixCls, mergedPicker) {
          return /*#__PURE__*/React.createElement(React.Fragment, null, mergedPicker === 'time' ? /*#__PURE__*/React.createElement(_ClockCircleOutlined["default"], null) : /*#__PURE__*/React.createElement(_CalendarOutlined["default"], null), _this.renderFeedback(prefixCls));
        };
        ...
        _this.renderPicker = function (contextLocale) {
          ...
          return /*#__PURE__*/React.createElement(_SizeContext["default"].Consumer, null, function (size) {
            ...
            return /*#__PURE__*/React.createElement(_context.FormItemStatusContext.Consumer, null, function (_ref2) {
              var _classNames;
